...
用法:
    python -m scripts.ingest.check_data_quality                          # 默认指数成分池
    python -m scripts.ingest.check_data_quality --begin 20250101 --end 20251231
    python -m scripts.ingest.check_data_quality --strict                 # 有 ERROR 时退出码 1
    python -m scripts.ingest.check_data_quality --out reports/data_quality.csv
...
def main():
    ...
    codes = pit_universe_codes(uni, index_code, args.begin or cfg["fetch"]["begin_date"], target)
