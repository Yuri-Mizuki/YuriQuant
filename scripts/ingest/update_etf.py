...
用法:
    python -m scripts.ingest.update_etf              # 用系统 Python 3.12（含 AmazingData SDK/凭证）
    python -m scripts.ingest.update_etf --begin 20180101
    python -m scripts.ingest.update_etf --end 20260826
