...
用法：
    python -m scripts.ingest.extend_factor_library --offline                  # 刷新到最新
    python -m scripts.ingest.extend_factor_library --offline --sets gp        # 只刷 GP
    python -m scripts.ingest.extend_factor_library --offline --verify-only    # 只校验不入库
"""
