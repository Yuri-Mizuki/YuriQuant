...
用法
----
    python -m scripts.build_intraday_stat_factors                 # 全量体检
    python -m scripts.build_intraday_stat_factors --no-dup        # 只入库不做冗余体检
    python -m scripts.build_intraday_stat_factors --features vol_rv,pv_vwap_dev
"""
