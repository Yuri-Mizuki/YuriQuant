...
用法：
    python scripts/reporting/investment_report.py --real --top 50
    python scripts/reporting/investment_report.py --real --top 50 --index 000001.SH
    python scripts/reporting/investment_report.py --mock --top 20 --model ridge   # 测试
"""
