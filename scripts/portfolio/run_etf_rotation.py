...
用法:
    python -m scripts.portfolio.run_etf_rotation                    # 默认参数跑通最小闭环
    python -m scripts.portfolio.run_etf_rotation --n 60 --top_k 3 --freq M
    python -m scripts.portfolio.run_etf_rotation --begin 20220101 --end 20260821
    python -m scripts.portfolio.run_etf_rotation --grid             # 跑参数稳健性交叉
    python -m scripts.portfolio.run_etf_rotation --out reports/etf_rotation/report.html
