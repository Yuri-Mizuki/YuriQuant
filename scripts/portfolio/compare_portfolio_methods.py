...
用法：
    python scripts/portfolio/compare_portfolio_methods.py                 # mock 默认
    python scripts/portfolio/compare_portfolio_methods.py --methods projection,min_var,hrp
    python scripts/portfolio/compare_portfolio_methods.py --n-days 500 --n-codes 60 --seed 7
    python scripts/portfolio/compare_portfolio_methods.py --out reports/portfolio_methods_compare.csv

    # 真实数据（需先 python -m scripts.ingest.update_data 拉取日线/行业/股本；PIT 并集池口径）
    python scripts/portfolio/compare_portfolio_methods.py --real --begin 20230101 --end 20241231
    ...
    for w in "20190101 20201231" "20210101 20221231" "20230101 20241231" "20250101 20261231"; do
      set -- $w
      python scripts/portfolio/compare_portfolio_methods.py --real --begin $1 --end $2 \
