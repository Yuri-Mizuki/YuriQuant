...
用法:
    # mock（无涨跌停/停牌，全可交易）
    python -m scripts.portfolio.generate_signals --freq M --method mvo --capital 100000000

    # 真实（需系统 Python D:\\python\\Python312\\python.exe，且先 update_data）
    python -m scripts.portfolio.generate_signals --real --begin 20250101 --end 20251231 --freq M --method mvo
