...
用法：
    python scripts/evaluation/cpcv_eval.py                          # mock 快速验证
    python scripts/evaluation/cpcv_eval.py --real                   # 真实 HS300
    python scripts/evaluation/cpcv_eval.py --real --n-groups 6 --k 2
    python scripts/evaluation/cpcv_eval.py --real --methods gp,exhaustive
