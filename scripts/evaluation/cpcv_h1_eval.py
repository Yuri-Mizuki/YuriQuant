...
用法：
    python scripts/evaluation/cpcv_h1_eval.py --mock                 # mock 验证管线
    python scripts/evaluation/cpcv_h1_eval.py --real                 # 真实 HS300 h=1
    python scripts/evaluation/cpcv_h1_eval.py --real --horizons 1,5  # 只比 h=1 vs h=5
    python scripts/evaluation/cpcv_h1_eval.py --real --n-groups 6 --k 2
...
def _build_real_data(horizon: int = 1):
    ...
    from scripts.common.e2e_common import DATASET, load_library_grid_panels
