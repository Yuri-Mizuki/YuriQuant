...
用法
----
    python -m scripts.evaluation.intraday_analysis --mock          # mock 验证管线（2023-2024）
    python -m scripts.evaluation.intraday_analysis                  # 真实 HS300 2025（默认）
    python -m scripts.evaluation.intraday_analysis --begin 20250101 --end 20251231
"""
