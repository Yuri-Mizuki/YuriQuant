...
用法:
    python scripts/evaluation/gp_tune_budget.py --grid "100x20,200x10,400x5,1000x3" --seeds 0,1,2
    python scripts/evaluation/gp_tune_budget.py --grid "200x10,1000x3" --seeds 0,1 --jobs 4
