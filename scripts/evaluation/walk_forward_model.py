...
模型层蓝图 Step 6（reports/docs/design/yuriquant_model_layer_design）：把 walk_forward.py
的三段纪律升级为模型级滚动训练。
...
用法：
    python scripts/evaluation/walk_forward_model.py --mock                     # 快速验证（无 SDK）
    python scripts/evaluation/walk_forward_model.py --mock --methods ridge,gbdt --save-library
    python scripts/evaluation/walk_forward_model.py --real                     # 因子库特征（2022-2025）
    python scripts/evaluation/walk_forward_model.py --real --raw-features      # 原始量价特征
"""
