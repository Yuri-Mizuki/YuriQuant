...
用法：
    python scripts/pipelines/e2e_backtest.py --real --top 50
    python scripts/pipelines/e2e_backtest.py --real --top 50 --freq W
    python scripts/pipelines/e2e_backtest.py --mock --top 20 --model ridge   # 测试/演示
"""
