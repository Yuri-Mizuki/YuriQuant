...
用法：
    python -m scripts.factors.fetch_textmining --universe hs300 --sources ths
    python -m scripts.factors.fetch_textmining --codes 600519.SH,000001.SZ --sources ths,cninfo
    python -m scripts.factors.fetch_textmining --universe hs300 --sources cninfo --categories 业绩预告 --with-pdf
    python -m scripts.factors.fetch_textmining --codes 600519.SH --limit 1   # 调试：只抓 1 只
