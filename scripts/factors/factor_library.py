...
示例:
    python scripts/factors/factor_library.py datasets
    python scripts/factors/factor_library.py list --dataset hs300_2025 --family 反转
    python scripts/factors/factor_library.py set-tag "ts_delta(amount,20)" --family 反转 --frequency 日频 --dataset hs300_2025
    python scripts/factors/factor_library.py monitor --dataset hs300_2025 --window 60
    python scripts/factors/factor_library.py compare --dataset hs300_2025 --metric sharpe --top 15
    python scripts/factors/factor_library.py view "ts_delta(amount,20)" --dataset hs300_2025 --start 20250101 --end 20250601 --regime
    python scripts/factors/factor_library.py report --dataset hs300_2025 --all --config ls_M --out reports/lib_report.xlsx
"""
...
def cmd_list(args):
    ...
    if df.empty:
        print("因子库为空。先运行 `python scripts/factors/mine_factors.py --save-library` 或合成 --save-library。")
        return
