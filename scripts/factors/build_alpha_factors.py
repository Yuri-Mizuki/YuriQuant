...
用法
----
    python -m scripts.factors.build_alpha_factors --offline                 # 默认 hs300_2022_2025
    python -m scripts.factors.build_alpha_factors --offline --no-save      # 只算不入库
    python -m scripts.factors.build_alpha_factors --offline --sets alpha101
    python -m scripts.factors.build_alpha_factors --mock                   # mock 验证
"""
...
def main():
    ...
    panels_px, industry, close_adj = load_alpha_panels(cache, uni, args.index, warmup, end)
