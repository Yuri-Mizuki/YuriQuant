...
用法
----
    python -m scripts.factors.build_fundamental_factors --offline          # 读缓存（推荐）
    python -m scripts.factors.build_fundamental_factors --mock             # mock 验证
    python -m scripts.factors.build_fundamental_factors --offline --no-save  # 只算不入库
"""
...
from scripts.common.fundamental_common import (  # noqa: E402
    add_single_quarter as _add_single_quarter,
    add_ttm_yoy,
)
