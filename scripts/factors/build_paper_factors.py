...
用法
----
    python -m scripts.factors.build_paper_factors --offline          # 读缓存（推荐）
    python -m scripts.factors.build_paper_factors --mock             # mock 验证
    python -m scripts.factors.build_paper_factors --offline --no-save  # 只算不入库
"""
...
from scripts.factors.build_fundamental_factors import add_ttm_yoy  # noqa: E402
