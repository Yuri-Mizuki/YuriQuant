...
用法
----
    python -m scripts.factors.build_technical_factors --offline            # 读缓存（推荐）
    python -m scripts.factors.build_technical_factors --mock               # mock 验证
    python -m scripts.factors.build_technical_factors --offline --no-save  # 只算不入库
"""
