...
用法:
    python scripts/factors/mine_factors.py                         # mock 数据（自带信号注入）
    python scripts/factors/mine_factors.py --real                  # 真实数据（需 SDK + 先 update_data）
    python scripts/factors/mine_factors.py --depth 1 --windows 5,10,20
    python scripts/factors/mine_factors.py --top 30 --out reports/mining.csv
