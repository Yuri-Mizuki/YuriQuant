...
与 scripts/factors/synthesize_factors.py --from-library 等价，但**不需要 SDK**：
...
用法
----
    python -m scripts.factors.synthesize_library --dataset hs300_2025
    python -m scripts.factors.synthesize_library --dataset hs300_2025 --methods ic_weighted,orthogonal
    python -m scripts.factors.synthesize_library --dataset mock --begin 20230103 --end 20241231
"""
