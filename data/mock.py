...
# ---- MockDataSource（2026-09-11 自 tests/conftest.py 下沉）----
# 此前脚本层经 `from tests.conftest import MockDataSource` 反向依赖测试包
# （cli_common 的 --mock 分支 / intraday_analysis）。数据源的 mock 属数据层
# 能力，归位本模块；conftest 保留同名字段转发，测试引用不受影响。
